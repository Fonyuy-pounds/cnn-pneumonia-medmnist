...
| Conv1 | Conv2D (16, 3×3) | (26, 26, 16) | 160 |
| Pool1 | MaxPooling2D | (13, 13, 16) | 0 |
| Conv2 | Conv2D (32, 3×3) | (11, 11, 32) | 4,640 |
| Pool2 | MaxPooling2D | (5, 5, 32) | 0 |
...
The model minimizes false negatives even at the cost of more false positives.

### Why No Horizontal Flipping?

Chest X-rays are anatomically asymmetric — the heart is on the left side. Horizontal flipping creates anatomically impossible images where the heart appears on the right. This would teach the model incorrect anatomical features and reduce diagnostic accuracy.

### Why Separate Data Preparation from Training?
...
- Assignment requirement — explicit separation required
...
- Minimal overfitting — training and validation curves stayed close
...
- Single dataset — may not generalize to X-rays from other sources
...
- Instructor Gita for project guidance
